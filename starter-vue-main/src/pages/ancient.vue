...
<template>
    <div class="total-progress-bar-fixed">
        ...
        <div class="game-btns-bar">
            ...
            <span v-if="canNextLevel && level === 2" class="game-over-msg">Συγχαρητήρια! Πάτησε για να αποκαλυφθεί το μυστικό</span>
        </div>
    </div>
    <div class="map-container">
        ...
        <div class="random-bananas">
            <img
                ...
                :style="`position:absolute; left:${b.left}%; bottom:${b.bottomPx}px; z-index:40; transition: bottom ${b.fallDuration ?? 20}s cubic-bezier(.4,0,.2,1); ${b.falling ? 'pointer-events:auto;cursor:pointer;' : 'pointer-events:none;cursor:default;'} `"
            ...
            <img
                ...
                :style="`position:absolute; left:${bb.left}%; bottom:${bb.bottomPx}px; z-index:41; transition: bottom ${bb.fallDuration ?? 20}s cubic-bezier(.4,0,.2,1); ${bb.falling ? 'pointer-events:auto;cursor:pointer;' : 'pointer-events:none;cursor:default;'} `"
